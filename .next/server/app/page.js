...
"use strict";
module.exports = __webpack_require__.p + "static/media/Inter-SemiBold.2a2f0a2a.ttf";
...
"use strict";
module.exports = __webpack_require__.p + "static/media/apple-touch-icon.08850a16.png";
...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3428)), "/home/patrick/Desktop/repo/liftoff/app/page.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4756))).default(props))],
    apple: [],
    openGraph: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2823))).default(props))],
    twitter: [],
    manifest: undefined
  }
        }]
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 729)), "/home/patrick/Desktop/repo/liftoff/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4756))).default(props))],
    apple: [],
    openGraph: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2823))).default(props))],
    ...
    const pages = ["/home/patrick/Desktop/repo/liftoff/app/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 339))
...
;// CONCATENATED MODULE: ./components/Gradient.js
/*
                ...
                value: class {
                    ...
                    getDeclaration(name, type, length) {
                        ...
                        if (uniform.excludeFrom !== type) {
                            if ("array" === uniform.type) if (uniform.value && uniform.value.length > 0 && uniform.value[0] && uniform.value[0].getDeclaration) {
...
function Home() {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(AnimatePresence/* AnimatePresence */.M, {
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: "min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden",
            children: [
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("svg", {
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("filter", {
                            id: "noise",
                            children: [
                                /*#__PURE__*/ jsx_runtime_.jsx("feTurbulence", {
                                    type: "fractalNoise",
                                    baseFrequency: ".7",
                                    numOctaves: "3",
                                    stitchTiles: "stitch"
                ...
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("main", {
                    ...
                    children: [
                        /*#__PURE__*/ jsx_runtime_.jsx(motion/* motion.svg */.E.svg, {
                            initial: {
                                opacity: 0,
                                y: 40
                            },
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)(motion/* motion.h1 */.E.h1, {
                            initial: {
                                opacity: 0,
                                y: 40
                            },
                                ...
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                                            className: "flex items-center font-semibold text-[1em] text-[#1a2b3b]",
                                            children: "Platform"
                                        }),
                                        /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                            className: "text-[14px] leading-[20px] text-[#1a2b3b] font-normal",
                                            children: "Full access to our platform, including all questions and solutions."
                                        })
                                    ]
                                }),
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                            className: "text-[14px] leading-[20px] text-[#1a2b3b] font-normal",
                                            children: "Join a community of like-minded individuals, and learn from each other."
                                        })
                                    ]
                                })
                            ]
                            ...
                            children: [
                                /*#__PURE__*/ jsx_runtime_.jsx(motion/* motion.div */.E.div, {
                                    ...
                                    children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)((link_default()), {
                                        ...
                                        children: [
                                            /*#__PURE__*/ jsx_runtime_.jsx("span", {
                                                className: "w-5 h-5 rounded-full bg-[#407BBF] flex items-center justify-center",
                ...
                /*#__PURE__*/ jsx_runtime_.jsx(motion/* motion.canvas */.E.canvas, {
                    initial: {
                        filter: "blur(20px)"
                    },
                    animate: {
                ...
                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    className: "h-[60px] bg-[#1D2B3A] fixed bottom-0 z-20 w-full flex flex-row items-center justify-evenly",
                    children: [
                        /*#__PURE__*/ jsx_runtime_.jsx("p", {
                            className: "text-white/80 text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap flex flex-row",
                            children: "Interviews from"
                        }),
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("svg", {
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("svg", {
                            ...
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("g", {
                                    clipPath: "url(#clip0_19_488)",
                                    children: [
                                        /*#__PURE__*/ jsx_runtime_.jsx("path", {
                                            d: "M5.99609 0H0V14.3398L5.99609 0Z",
                                            fill: "white"
                                        }),
                                        /*#__PURE__*/ jsx_runtime_.jsx("path", {
                                            d: "M10.2148 0H16.2031V14.3398L10.2148 0Z",
                                            fill: "white"
                                        }),
                                        /*#__PURE__*/ jsx_runtime_.jsx("path", {
...
const metadata = {
    ...
    openGraph: {
        title: "Liftoff - AI-Powered Mock Interviews",
        description: "Liftoff is an AI-powered mock interview platform that helps you practice for your next job interview.",
        images: [
            {
    ...
    twitter: {
        ...
        description: "Liftoff is an AI-powered mock interview platform that helps you practice for your next job interview.",
        images: [
            "https://demo.useliftoff.com/opengraph-image"
        ],
        creator: "@tmeyer_me"
    },
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/patrick/Desktop/repo/liftoff/app/page.tsx`)
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"src":"/_next/static/media/apple-touch-icon.08850a16.png","height":180,"width":180,"blurDataURL":"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAMAAADz0U65AAAAGFBMVEVMaXEdKDscKDobKDsaKDkeJzweJjgeKjyJ66lcAAAACHRSTlMAaYYoHFU7wTD40fUAAAAJcEhZcwAACxMAAAsTAQCanBgAAAAdSURBVHicY2BAABZmKIORCTeDnZENopiVEaYcBAAFXQAt8edLUAAAAABJRU5ErkJggg==","blurWidth":8,"blurHeight":8});
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ opengraph_image_next_metadata)
});

// NAMESPACE OBJECT: ./app/opengraph-image.tsx
var opengraph_image_namespaceObject = {};
__webpack_require__.r(opengraph_image_namespaceObject);
__webpack_require__.d(opengraph_image_namespaceObject, {
  "alt": () => (alt),
...
;// CONCATENATED MODULE: ./app/opengraph-image.tsx
/* eslint-disable @next/next/no-img-element */ 

const runtime = "edge";
const alt = "Precedent - Building blocks for your Next.js project";
const contentType = "image/png";
async function OG() {
    // Font
    const interSemiBold = await fetch(/* asset import */ new __webpack_require__.U(__webpack_require__(263))).then((res)=>res.arrayBuffer());
    return new image_response/* default */.Z(/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        style: {
            height: "100%",
            width: "100%",
            display: "flex",
            ...
            backgroundImage: "linear-gradient(to bottom right, #E0E7FF 25%, #ffffff 50%, #bde1ff 75%)"
        },
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("img", {
                src: /* asset import */ new __webpack_require__.U(__webpack_require__(9842)).toString(),
                alt: "Liftoff Logo",
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                style: {
                    fontSize: "100px",
                    background: "linear-gradient(to bottom right, #1E2B3A 21.66%, #78716c 86.47%)",
                    backgroundClip: "text",
                    color: "transparent",
                    lineHeight: "5rem",
                    letterSpacing: "-0.02em"
                },
                children: "AI Mock Interviews"
            })
        ]
    }), {
        width: 1200,
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-metadata-image-loader.js?type=openGraph&segment=&basePath=&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js!./app/opengraph-image.tsx?__next_metadata
    
    

    const imageModule = { ...opengraph_image_namespaceObject }
    /* harmony default export */ async function opengraph_image_next_metadata(props) {
      ...
      function getImageMetadata(imageMetadata, idParam) {
        const data = {
          ...
          url: imageUrl + (idParam ? ('/' + idParam) : '') + "?e1962c58499f958f",
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [836,16], () => (__webpack_exec__(4967)));
